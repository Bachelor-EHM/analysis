...
```{r}
#Min and max sat + hue value in each chain

#DANISH
aggregate(danish$Rel_dif,
          by = list(Chain = danish$Chain,
                    Condition = danish$Condition),
          max)
...
aggregate(danish$Saturation_matched,
          by = list(Chain = danish$Chain,
                    Condition = danish$Condition),
          max)
